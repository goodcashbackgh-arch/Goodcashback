    ...
    <main className="min-h-screen bg-slate-50 px-6 py-8 text-slate-950">
      <div className="mx-auto max-w-6xl rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600">
          Next wiring step: review invoice-first, tracking-first, OCR lines,
          manual lines, and progressed subset using supplier_invoices,
          supplier_invoice_lines, order_tracking_submissions, and
