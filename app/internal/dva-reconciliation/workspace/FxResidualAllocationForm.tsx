...
import { allocateStatementLineResidualAction } from "../finalBalanceResidualActions";
...
export default function FxResidualAllocationForm({
  ...
  return (
    <form action={allocateStatementLineResidualAction} className="flex flex-wrap gap-2">
