          ...
          <div className="mt-2 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-4xl text-sm leading-6 text-slate-600">
                Configure the Sage tax-rate and ledger/account ids needed before any posting adapter can run. This page can also run read-only Sage catalogue checks. It does not post invoices, purchase invoices, payments or credit notes.
              </p>
            </div>
        ...
        <section className="rounded-3xl border border-violet-200 bg-white p-5 shadow-sm sm:p-6">
          <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <h2 className="mt-1 text-xl font-semibold">API check for AR/AP mapping data</h2>
