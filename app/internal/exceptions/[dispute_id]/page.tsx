...
function finalOutcomeMessage(dispute: { desired_outcome: string | null; status: string | null; replacement_child_order_id?: string | null }) {
  if (dispute.desired_outcome === "replacement" && dispute.status === "replaced") return dispute.replacement_child_order_id ? "Replacement accepted — child order created." : "Replacement accepted — same-order replacement.";
