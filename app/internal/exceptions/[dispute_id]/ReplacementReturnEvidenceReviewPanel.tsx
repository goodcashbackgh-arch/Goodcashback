  ...
  return (
    <section className="rounded-3xl border border-violet-200 bg-white p-6 shadow-sm">
      ...
      <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
        Review the operator&apos;s original-item return or collection instructions and evidence. This review is operational only; it does not approve supplier refund value, customer settlement, accounting, or replacement-child funding.
      </p>
        ...
        {submissions.map((submission) => (
          <article key={submission.id} className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            <div className="mt-4 flex flex-wrap gap-3 text-sm">
              ...
              {submission.trackingEvidenceUrl ? <a href={submission.trackingEvidenceUrl} target="_blank" rel="noreferrer" className="font-semibold text-sky-700 underline">Tracking / evidence</a> : null}
