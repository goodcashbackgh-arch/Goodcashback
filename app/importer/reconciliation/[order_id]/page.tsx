                        ...
                        <form action={updateSupplierInvoiceLineAction} className="grid gap-3 md:grid-cols-12">
                          ...
                          <label className="space-y-1 text-sm md:col-span-6">
                            ...
                            <input
                              ...
                              required
                              readOnly={isOcrLine}
                              title={isOcrLine ? "OCR description is source evidence and cannot be changed." : undefined}
                              className={`w-full rounded-xl border border-slate-300 px-3 py-2 ${isOcrLine ? "bg-slate-100 text-slate-600" : ""}`}
                            />
