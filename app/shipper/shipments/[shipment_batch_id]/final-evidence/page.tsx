        ...
        <section className="rounded-3xl border border-amber-200 bg-amber-50 p-5 shadow-sm sm:p-6">
          ...
          {!completionReady ? (
            ...
            <form action={submitFinalExportEvidenceAction} className="mt-5 grid gap-3 md:grid-cols-2">
              ...
              <label className="space-y-1 text-sm"><span className="text-xs uppercase tracking-wide text-amber-800">Document type</span><select name="document_kind" required className="w-full rounded-xl border border-amber-300 bg-white px-3 py-2 text-slate-950"><option value="pod_delivery_evidence">POD / delivery evidence</option><option value="completed_cos">Completed signed/stamped COS</option><option value="final_eep_packing_list">Final EEP / packing list if amended</option><option value="mbl_bol_sea_waybill">MBL / BOL / sea waybill</option><option value="container_seal_evidence">Container / seal evidence</option><option value="export_date_departure_evidence">Export date / departure evidence</option><option value="other_final_export_evidence">Other final export evidence</option></select></label>
              <label className="space-y-1 text-sm"><span className="text-xs uppercase tracking-wide text-amber-800">Document ref</span><input name="document_ref" placeholder="POD ref, COS ref, MBL ref, container ref, etc." className="w-full rounded-xl border border-amber-300 bg-white px-3 py-2 text-slate-950" /></label>
