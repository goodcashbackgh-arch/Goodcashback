...
WITH seed(mapping_code, display_name, description, required_for, sage_external_id, sage_display_name) AS (
  VALUES
    ...
    ('VAT_BOX7_CARRIAGE_ON_PURCHASES_LEDGER', 'VAT Box 7 carriage on purchases ledger', 'Sage purchase carriage ledger used to reconcile VAT Box 7. Standard Sage nominal: Carriage on Purchases (5100).', ARRAY['vat_return_reconstruction','vat_box_7']::text[], 'ea29af73be211f194130283b27a38ab', 'Carriage on Purchases (5100)'),
