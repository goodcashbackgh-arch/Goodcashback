...
-- Contract v5 runtime hardening:
-- Batch detail must expose AP VAT split and source invoice evidence before Sage posting.
-- No Sage API call. No posting. Adds derived output columns only.
