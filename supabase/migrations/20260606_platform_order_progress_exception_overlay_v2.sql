...
-- Refines the 12-gate progress overlay so downstream not-ready gates are not automatically
-- reported as exceptions. Exceptions should identify the current/true blocker, not duplicate
-- dependent downstream gates.
      ...
      (
        ...
        FROM (
          VALUES
            ...
            (CASE WHEN g.current_stage IN ('tracking_missing','shipment_allocation_incomplete') THEN 'tracking_package_exception' END),
