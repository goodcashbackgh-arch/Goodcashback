...
-- Fix customer sales invoice intent at source.
-- The Sage sales invoice line description must come from the allocated supplier/retailer
-- product line where available, not a generic booking charge label.
-- No posting. No table/data deletion.
