-- =============================================================================
-- 20260510_shipper_batch_header_no_export_refs_v1.sql
--
-- Purpose:
--   Keep importer shipment batch header edits scoped to booking/dispatch/package
--   facts only. Container/BOL/master shipment/final export evidence belongs to
--   the later master-shipment/export-evidence lane and must not be silently
--   edited or cleared here.
-- =============================================================================
