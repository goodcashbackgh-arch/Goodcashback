-- Fix staff_request_refund_document_resubmission audit insert to use allowed dispute_messages values.
-- Live dispute_messages constraints allow generated_by = manual and message_type = supervisor_note.
-- Previous function body used generated_by = supervisor_review, which violates the check constraint.
--
-- Scope: replace only this RPC body. No table/state/flow changes.
...
BEGIN
  ...
  INSERT INTO public.dispute_messages (
    ...
    array_to_string(array[
      '[REFUND_DOCUMENT_STAFF_RESUBMISSION_APPROVED_V1]',
