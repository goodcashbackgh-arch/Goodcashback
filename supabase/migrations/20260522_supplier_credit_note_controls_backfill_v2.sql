...
-- v2: live sage_posting_snapshots has no updated_at column.
-- Same intent as v1: lift controls from source_payload.controls to top-level controls for supplier credit note posting.
