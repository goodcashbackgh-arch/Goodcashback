...
-- Completion loyalty pairing/accounting control fix v2.
-- Keep completion_loyalty_reward excluded from normal customer self-service credit,
-- but do not let loyalty-linked debit rows virtually consume normal account-credit lots.
