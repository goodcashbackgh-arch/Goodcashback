...
-- Narrow guard only: empty shipment batches must not ask the shipper to upload
-- final export/POD evidence. They need package contents first.
-- Supervisor/AP logic is untouched.
