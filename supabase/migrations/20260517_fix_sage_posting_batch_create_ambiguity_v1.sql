...
-- Fix Phase 10 batch creation RPC ambiguity.
-- Root cause: RETURNS TABLE includes output column batch_ref, while INSERT ... RETURNING also referenced batch_ref unqualified.
-- Scope: replace only internal_create_sage_posting_batch_from_filter_v1. No table changes. No Sage API calls.
