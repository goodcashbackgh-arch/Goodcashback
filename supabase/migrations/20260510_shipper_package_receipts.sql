-- =============================================================================
-- 20260510_shipper_package_receipts.sql
-- Multi Tenant Platform Build — shipper package receipt controls
--
-- Purpose:
--   Let authenticated shipper users record package-level physical truth against
--   an existing order tracking submission. This does not lock item-content
--   allocation and does not create shipment batches, COS/BOL, Sage, VAT or
--   financial effects.
--
-- Governing rule:
--   Shipper confirms package movement/condition. Operator/supervisor confirms
--   item-content truth.
-- =============================================================================
