...
-- Superseded branch-only draft retained as a no-op because the file already exists
-- in branch history. The governing implementation is entirely contained in:
-- 20260810_same_order_supplier_price_increase_v1.sql
--
-- Do not recreate the withdrawn verified-bundle read model or global supplier
-- approval transition guard here.
