...
28. Completion-loyalty internal-transfer live posting must not be enabled by generic cash-posting flags. Use the dedicated internal-transfer journal posting flag only unless a later locked addendum introduces a documented generic Sage-journal flag.
