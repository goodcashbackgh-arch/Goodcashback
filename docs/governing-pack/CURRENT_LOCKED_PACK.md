...
19. Signed OCR Financial Line and Supplier AP Payload Addendum v1 (`docs/governing-pack/architecture/SIGNED_OCR_FINANCIAL_LINE_AND_SUPPLIER_AP_PAYLOAD_ADDENDUM_v1.md`) — locks signed Mindee source preservation, explicit non-physical classification, signed supervisor coding and one-time supplier AP/Sage payload inclusion while preserving ordinary positive-line behaviour.
