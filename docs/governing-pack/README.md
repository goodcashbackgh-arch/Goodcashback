...
- `architecture/` — governing architecture and implementation-alignment addenda, including `HYBRID_PHYSICAL_RECEIPT_QUANTITY_FULFILMENT_AND_REMEDY_CONTROL_ADDENDUM_v1.md`.
