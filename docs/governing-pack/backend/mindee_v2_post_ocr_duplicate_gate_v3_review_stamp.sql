-- =============================================================================
-- mindee_v2_post_ocr_duplicate_gate_v3_review_stamp.sql
-- Multi Tenant Platform Build — post-OCR duplicate gate review stamp fix
--
-- Purpose:
--   Fix supplier_invoices_review_resolution_check failure when the post-OCR
--   duplicate trigger marks an invoice as duplicate_blocked.
--
-- Why:
--   supplier_invoices.review_status = duplicate_blocked requires reviewed_at
--   to be populated. The duplicate trigger correctly detected the duplicate,
--   but did not stamp reviewed_at.
-- =============================================================================
