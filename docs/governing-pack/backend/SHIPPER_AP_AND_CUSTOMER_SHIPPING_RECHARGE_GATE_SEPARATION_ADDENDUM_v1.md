...
**Implementation status:** Contract clarified from live evidence — migration rebuild not yet approved for execution  
...
Regression must prove protected table contents or fingerprints are restored by rollback, not merely compare counts before rollback.
