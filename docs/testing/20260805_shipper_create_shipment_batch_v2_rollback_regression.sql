...
BEGIN
  ...
  SELECT
    ...
    COUNT(*) FILTER (
      WHERE m.tracking_line_allocation_id = '9dd8c47c-9dd9-4191-910b-41095f15feee'::uuid
    )::integer,
    COUNT(*) FILTER (
      WHERE m.tracking_line_allocation_id <> '9dd8c47c-9dd9-4191-910b-41095f15feee'::uuid
    )::integer
  ...
  RAISE NOTICE 'PASS — exact shipment batch v2 created one clean membership qty 1; four diverted allocations excluded; all writes roll back.';
END $$;
