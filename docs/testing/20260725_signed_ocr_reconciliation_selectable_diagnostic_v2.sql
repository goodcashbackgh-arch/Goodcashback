-- V2: read-only SQL Editor diagnostic for the missing bulk progression controls
-- on order abf15b7b-771f-482f-9751-2af0ee0bcbb1 / NIN-240726-A.
--
...
-- The UNION result is wrapped before ORDER BY; there is no CASE expression in
-- the UNION ORDER BY clause.
